function mostrar()
{
	...
	{
		alert("La bolsa mas liviana es de " + minimoCarne + " y su sabor es carne");
	}
	...
	else
	{
		...
		{
			alert("La bolsa mas liviana es de " + minimoVegetales + " y su sabor es vegetales");
		}

		else
		{
			alert("La bolsa mas liviana es de " + minimoPollo + " y su sabor es pollo");
		}
	}
